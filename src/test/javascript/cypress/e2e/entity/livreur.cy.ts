...
describe('Livreur e2e test', () => {
  ...
  const livreurSample = { idL: 89480, nomL: 'Cbspzhe', prenomL: 'Ufjicx' };
  ...
  describe('new Livreur page', () => {
    ...
    it('should create an instance of Livreur', () => {
      cy.get(`[data-cy="idL"]`).type('36772').should('have.value', '36772');

      cy.get(`[data-cy="nomL"]`).type('Oc').should('have.value', 'Oc');

      cy.get(`[data-cy="prenomL"]`).type('Trqd').should('have.value', 'Trqd');
