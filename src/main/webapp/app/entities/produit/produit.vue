      ...
      <table class="table table-striped" aria-describedby="produits">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('coopcycleApp.produit.commande')">Commande</span></th>
            <th scope="row"><span v-text="$t('coopcycleApp.produit.client')">Client</span></th>
        ...
        <tbody>
          <tr v-for="produit in produits" :key="produit.id" data-cy="entityTable">
            ...
            <td>{{ produit.prix }}</td>
            <td>
              <div v-if="produit.commande">
                <router-link :to="{ name: 'CommandeView', params: { commandeId: produit.commande.id } }">{{
                  produit.commande.id
                }}</router-link>
              </div>
            </td>
            <td>
              <div v-if="produit.client">
                <router-link :to="{ name: 'ClientView', params: { clientId: produit.client.id } }">{{ produit.client.id }}</router-link>
              </div>
            </td>
            <td>
