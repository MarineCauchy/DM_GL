...
describe('Commande e2e test', () => {
  ...
  const commandeSample = { idCo: 58224, prixTotal: 89476, date: '2023-04-08T23:51:33.972Z', adresseLivraison: 'frictionless b' };
  ...
  describe('new Commande page', () => {
    ...
    it('should create an instance of Commande', () => {
      cy.get(`[data-cy="idCo"]`).type('53606').should('have.value', '53606');

      cy.get(`[data-cy="prixTotal"]`).type('76535').should('have.value', '76535');

      cy.get(`[data-cy="date"]`).type('2023-04-09T06:52').blur().should('have.value', '2023-04-09T06:52');

      cy.get(`[data-cy="adresseLivraison"]`).type('Dominican').should('have.value', 'Dominican');
