...
describe('Restaurant e2e test', () => {
  ...
  const restaurantSample = { nom: 'GB', adresse: 'Cambridgeshire' };
  ...
  describe('new Restaurant page', () => {
    ...
    it('should create an instance of Restaurant', () => {
      cy.get(`[data-cy="nom"]`).type('XML').should('have.value', 'XML');

      cy.get(`[data-cy="adresse"]`).type('lavender').should('have.value', 'lavender');
