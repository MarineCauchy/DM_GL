...
describe('Association e2e test', () => {
  ...
  const associationSample = { idA: 97462, nomA: 'Pula' };
  ...
  describe('new Association page', () => {
    ...
    it('should create an instance of Association', () => {
      cy.get(`[data-cy="idA"]`).type('75580').should('have.value', '75580');

      cy.get(`[data-cy="nomA"]`).type('Centre').should('have.value', 'Centre');
